...
> NOTE: we are planning to sunset `dabs.sh`, we recommend running locally as pure python.
> 
...
> 
> All the examples below and under [docs](docs) using `dabs.sh ...` can run with `python -m app_build_suite ...` too.
> ```
