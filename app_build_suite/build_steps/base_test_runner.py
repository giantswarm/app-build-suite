...
class BaseTestRunner(BuildStep, ABC):
    ...
    def _ensure_app_platform_ready(self, kube_config_path: str) -> None:
        ...
        run_res = run_and_log(args, print_debug=True)  # nosec, file is either autogenerated or in user's responsibility
    ...
    def pre_run(self, config: argparse.Namespace) -> None:
        ...
        # verify version
        run_res = run_and_log([self._apptestctl_bin, "version"], print_debug=True)  # nosec
